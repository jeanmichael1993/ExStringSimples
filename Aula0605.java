...
int i = original.indexOf("bc"); /* mostra a primeira posição onde tem bc */
int j = original.lastIndexOf("bc"); /* retorna a posição da ultima ocorrencia do bc*/
/*S.charAt(posição) pega o char da posição*/
